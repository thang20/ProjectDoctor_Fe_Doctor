    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takeSkin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Apiservice.apiservice.skindt(body).enqueue(new Callback<ResponseBody>() {
                        @Override
                        public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                            ...
                            try {
                                ...
                                if(notice.equals("success")){
                                    Toast.makeText(HeraSkin.this, "Success to register Skill", Toast.LENGTH_LONG).show();
                                    progressDialog.dismiss();
                                    startActivity(new Intent(HeraSkin.this, Home.class));
                                    finish();
                                }else {
                                    progressDialog.dismiss();
                                    Toast.makeText(HeraSkin.this, "Fail to change password", Toast.LENGTH_LONG).show();
                                }
