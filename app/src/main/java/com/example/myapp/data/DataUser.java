...
//    }
    ...
    public List<ItemNewDataSpecservice> listSPECSERVICE = new ArrayList<>();

    public List<ItemNewDataSpecservice> getListSPECSERVICE() {
        return listSPECSERVICE;
    }

    public void setListSPECSERVICE(List<ItemNewDataSpecservice> listSPECSERVICE) {
        this.listSPECSERVICE = listSPECSERVICE;
    }
