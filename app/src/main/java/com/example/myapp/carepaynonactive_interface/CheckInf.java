...
public class CheckInf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setText(MyApplication.getMyApplication().getDataUser().getIdcard());
        ...
        not.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(CheckInf.this, "Please correct any incorrect information", Toast.LENGTH_LONG).show();
            }
        });
